...
# Merge geopoint of zpi codes and join area names and codes on each zip code with lat lon
python run_sql.py -s zip_codes_with_areas.sql -d ../docker-compose.yml